...
<ol>
    ...
    <ul>
        ...
        <li>Describe the terms úToken, úSmart Card and úBiometry and explain their use for authentication</li>
        ...
        <li>Explain in detail format, composition and use of certificates. Also describe úCertificate Authorities, úRoot-CA and úCertificate revocation.</li>
    ...
    <ul>
        ...
        <li>inherent weaknesses and vulnerabilities in the concept ‚ÄúFirewall‚Äù</li>
